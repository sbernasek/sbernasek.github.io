...
![Regulatory tradeoffs](/img/research/metabolism_coords.png =150x){: .center-block :}
...
![Evolutionary role for regulatory repressors](/img/research/metabolism_race.png =150x){: .center-block :}
...
![Fly-QMA pipeline](/img/research/flyqma.png =150x){: .center-block :}
...
![Expression dynamics in the developing eye](/img/research/ratio.png =150x){: .center-block :}
